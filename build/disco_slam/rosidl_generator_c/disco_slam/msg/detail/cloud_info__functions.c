...
disco_slam__msg__CloudInfo__init(disco_slam__msg__CloudInfo * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    disco_slam__msg__CloudInfo__fini(msg);
    return false;
  }
  // start_ring_index
...
disco_slam__msg__CloudInfo__create()
{
  ...
  disco_slam__msg__CloudInfo * msg = (disco_slam__msg__CloudInfo *)allocator.allocate(sizeof(disco_slam__msg__CloudInfo), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(disco_slam__msg__CloudInfo));
  bool success = disco_slam__msg__CloudInfo__init(msg);
  if (!success) {
...
disco_slam__msg__CloudInfo__Sequence__init(disco_slam__msg__CloudInfo__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  disco_slam__msg__CloudInfo * data = NULL;

  if (size) {
    data = (disco_slam__msg__CloudInfo *)allocator.zero_allocate(size, sizeof(disco_slam__msg__CloudInfo), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = disco_slam__msg__CloudInfo__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        disco_slam__msg__CloudInfo__fini(&data[i - 1]);
      }
...
disco_slam__msg__CloudInfo__Sequence__fini(disco_slam__msg__CloudInfo__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      disco_slam__msg__CloudInfo__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  disco_slam__msg__CloudInfo__Sequence * array = (disco_slam__msg__CloudInfo__Sequence *)allocator.allocate(sizeof(disco_slam__msg__CloudInfo__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = disco_slam__msg__CloudInfo__Sequence__init(array, size);
  if (!success) {
...
disco_slam__msg__CloudInfo__Sequence__destroy(disco_slam__msg__CloudInfo__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    disco_slam__msg__CloudInfo__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
disco_slam__msg__CloudInfo__Sequence__are_equal(const disco_slam__msg__CloudInfo__Sequence * lhs, const disco_slam__msg__CloudInfo__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!disco_slam__msg__CloudInfo__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  disco_slam__msg__CloudInfo__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(disco_slam__msg__CloudInfo);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    disco_slam__msg__CloudInfo * data =
      (disco_slam__msg__CloudInfo *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!disco_slam__msg__CloudInfo__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          disco_slam__msg__CloudInfo__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!disco_slam__msg__CloudInfo__copy(
