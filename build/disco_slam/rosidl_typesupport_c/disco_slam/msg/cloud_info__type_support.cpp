...
static const _CloudInfo_type_support_symbol_names_t _CloudInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, disco_slam, msg, CloudInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, disco_slam, msg, CloudInfo)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, disco_slam, msg, CloudInfo)() {
  return &::disco_slam::msg::rosidl_typesupport_c::CloudInfo_message_type_support_handle;
}
