...
#include "disco_slam/msg/detail/cloud_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const disco_slam::msg::CloudInfo & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  disco_slam::msg::CloudInfo & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = disco_slam::msg::CloudInfo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const disco_slam::msg::CloudInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<disco_slam::msg::CloudInfo *>(
    untyped_ros_message);
...
{
  return &disco_slam::msg::typesupport_fastrtps_cpp::_CloudInfo__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, disco_slam, msg, CloudInfo)() {
  return &disco_slam::msg::typesupport_fastrtps_cpp::_CloudInfo__handle;
}
