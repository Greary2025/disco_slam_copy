...
private:
    ...
    bool gravity_constraint_enabled;
...
public:
    ...
    void forceInitWithoutGravity(const std::vector<std::pair<double, std::pair<Eigen::Vector3d, Eigen::Vector3d>>> &imu_meas);
    ...
    bool isGravityConstraintEnabled() const;
