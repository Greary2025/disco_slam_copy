...
#ifndef DISCO_SLAM__MSG__DETAIL__CLOUD_INFO__TRAITS_HPP_
#define DISCO_SLAM__MSG__DETAIL__CLOUD_INFO__TRAITS_HPP_
...
inline void to_yaml(
  const disco_slam::msg::CloudInfo & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const disco_slam::msg::CloudInfo & msg)
{
  return disco_slam::msg::to_yaml(msg);
}

template<>
inline const char * data_type<disco_slam::msg::CloudInfo>()
{
  return "disco_slam::msg::CloudInfo";
}

template<>
inline const char * name<disco_slam::msg::CloudInfo>()
{
  return "disco_slam/msg/CloudInfo";
}

template<>
struct has_fixed_size<disco_slam::msg::CloudInfo>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<disco_slam::msg::CloudInfo>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<disco_slam::msg::CloudInfo>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // DISCO_SLAM__MSG__DETAIL__CLOUD_INFO__TRAITS_HPP_
