...
bool disco_slam__msg__cloud_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("disco_slam.msg._cloud_info.CloudInfo", full_classname_dest, 36) == 0);
  }
  disco_slam__msg__CloudInfo * ros_message = _ros_message;
  {  // header
...
PyObject * disco_slam__msg__cloud_info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("disco_slam.msg._cloud_info");
